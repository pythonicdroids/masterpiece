...
def backwards_until_reflection_white(speed, reflection, use_right, use_left ):
   ...
   while True:
      ...
      wait(500)
      if use_right == True and use_left == False:
         if right_color_sensor.reflection() < reflection and right_color_sensor.reflection() > 56 :
            right_motor.brake()
            left_motor.brake()
            break

      if use_right == False and use_left == True:
         if left_color_sensor.reflection() < reflection and left_color_sensor.reflection() > 56 :
            right_motor.brake()
            left_motor.brake()
            break
...
backwards(300, 51)
left_turn(68)
backwards_until_reflection_black(300, 10, False, True)
left_turn(21)
right_motor.run_time(-180, 2200, wait = False)
left_motor.run_time(180, 2200, wait = True)
wait(10)
left_turn(2)
...
if doing_mission7 == True:
   ...
   forward(100, 18)
   left_turn(94)
   right_motor.run_time(340, 3000, wait = False)
   left_motor.run_time(-340, 3000, wait = True)
   left_turn(20)
   right_motor.run_time(140, 1500, wait = False)
   left_motor.run_time(-140, 1500, wait = True)
   backwards(400, 10)
   wait(10)
   left_turn(90)
   backwards(400, 70)
